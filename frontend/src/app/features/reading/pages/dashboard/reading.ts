...
} from '@app/services/reading.service';
import { SuggestionsService, ReadingSuggestion } from '@app/services/suggestions.service';
...
export class Reading implements OnInit {
  ...
  readingSuggestions = signal<ReadingSuggestion[]>([]);
  ...
  private loadSuggestions(refresh = false) {
    this.suggestionsLoading.set(true);
    this.suggestionsSvc.getReadingSuggestions(refresh).subscribe(res => {
      this.readingSuggestions.set(res.suggestions);
