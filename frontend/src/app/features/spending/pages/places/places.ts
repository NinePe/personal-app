...
import { PlacesService, PlaceStat } from '@app/services/places.service';
import { BudgetService, Category } from '@app/services/budget.service';
...
export class Places implements OnInit {
  ...
  ngOnInit() {
    this.budgetSvc.getCategories().subscribe(cats => this.categories.set(cats));
    this.load();
  }
  ...
  deletePlace(id: string) {
    ...
    this.placesSvc.deletePlace(id).subscribe(() =>
